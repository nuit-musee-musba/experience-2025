...
const modal = new Modal(
  "modal",
  "This is the modal content Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolorum ex praesentium quo nam molestiae earum, cum consequuntur? Illo accusantium harum quo voluptas ipsam obcaecati suscipit ea fugit, ducimus alias quis.",
  "test-css",
  testDiv
);
...
textButton.on("clicked", () => {
  console.log("Button clicked");
});

arrowButton.on("clicked", () => {
